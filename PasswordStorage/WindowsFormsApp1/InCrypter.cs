...
{
    class Shifrator:IShifrator
    {
        private string sol = "shifrovanie";
        private string cryptographicAlgorithm = "SHA1";
        private int passIter = 2;
        private string initVec = "a8doSuDitOz1hZe#";
        private int keySize = 256;
        public Shifrator() { }
        public string Encrypt(string ishText, string pass)
        {
